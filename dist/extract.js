 ...
 */
function generateCitation(title, url, author) {
...
export function extractContent(html, url, options = {}) {
    const { format = 'markdown', includeImages = true, includeLinks = true, maxLength = config.maxSize } = options;
    // Parse HTML
 ...
 */
export function summarizeContent(content, maxLength = 500, format = 'paragraph') {
